...
Paralelamente à minha atuação no mercado, sou estudante de **Análise e Desenvolvimento de Sistemas**, buscando unir a prática empreendedora com uma base teórica sólida em tecnologia.

---

**Minhas principais competências:**
- **Construção de Produto:** Da ideia ao lançamento (MVP)
- **Design:** UI/UX, Prototipação (Figma)
- **No-Code:** Bubble.io, FlutterFlow
- **Automação:** N8N
- **Tecnologias (em desenvolvimento):** Python, Java, SQL, Git

---

**Onde me encontrar:**
- **LinkedIn:** [linkedin.com/in/tavaresrafael](https://www.linkedin.com/in/tavaresrafael/)
- **Website:** [minni.link/rafael](https://minni.link/rafael)
